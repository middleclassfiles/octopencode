...
export const TERMINAL_REGISTRY_RELATIVE_PATH = ".hydra/state/tentacles.json";
export const TERMINAL_TRANSCRIPT_RELATIVE_PATH = ".hydra/state/transcripts";
export const TENTACLE_WORKTREE_RELATIVE_PATH = ".hydra/worktrees";
export const TENTACLE_WORKTREE_BRANCH_PREFIX = "hydra/";
export const DEFAULT_AGENT_PROVIDER = "opencode" as const;
