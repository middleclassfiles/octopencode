...
1. Read `.hydra/tentacles/{{tentacleId}}/todo.md`.
2. Read `.hydra/tentacles/{{tentacleId}}/CONTEXT.md` and any other markdown files in that tentacle folder that clarify scope.
...
6. After operator confirmation, write the updated `.hydra/tentacles/{{tentacleId}}/todo.md`.
